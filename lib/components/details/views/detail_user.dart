...
import 'package:minha_loja_eixo/components/forms/data/data_user_history.dart';
import 'package:minha_loja_eixo/components/forms/views/base_form.dart';
import 'package:minha_loja_eixo/components/lists/views/view_list_history.dart';
...
import 'package:minha_loja_eixo/components/details/views/detail_profile_social_link.dart';
import 'package:minha_loja_eixo/components/details/views/detail_profile_user.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const ListHistory(),
        BaseForm(
          formInputs: historyInputs,
          apiRoute: 'https://api.eixo.site/history/${userData.id}',
        ),
      ],
    );
  }
