...
class ControllerRedeem extends GetxController {
  ...
  loadAllItems({int? page = 1}) async {
    ...
    var databaseResponse =
        await get(apiRoute: 'https://api.eixo.site/redeems/?page=$page');
  ...
  filterItemsByQuery({required Map<dynamic, dynamic> params}) async {
    ...
    var databaseResponse =
        await get(apiRoute: 'https://api.eixo.site/redeems/?$query');
